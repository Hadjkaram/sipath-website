  ...
  return (
    <main className="min-h-screen bg-[#FDF6F0] pt-40 pb-24 px-12 flex flex-col items-center">
      <div className="w-full max-w-5xl">
        ...
        <h1 className="text-5xl md:text-6xl text-[#2C2522] font-light leading-tight mb-16">
          Une vision commune pour <br />
          <span className="font-medium text-[#F26522]">l'Anatomopathologie</span> moderne.
        </h1>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 text-[#6B5B4F] leading-relaxed text-lg font-light">
          <div>
            <h2 className="text-[#2C2522] text-xl font-medium uppercase tracking-wider mb-6 border-b border-[#E8D9C9] pb-3">
